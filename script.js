 ...
 */ !(function (t) {
	...
	function (t, e, n) {
		...
		window.tram = (function (t) {
			...
			var l = (function (t, e, n) {
				...
				S = function (t) {
					...
					for (e = 0; e < T.length; e++)
						if ((n = T[e] + i) in L.style) return { dom: n, css: C[e] + t };
				},
				R = (e.support = {
			...
			if (R.transition) {
				var D = R.timing.dom;
				if (((L.style[D] = f["ease-in-back"][0]), !L.style[D]))
					for (var I in d) f[I][0] = d[I];
			}
				...
				W = l(function (e) {
					function n() {
						var t,
							...
							i,
							r = u.length;
						if (r) for (M(n), e = z(), t = r; t--; ) (i = u[t]) && i.render(e);
					}
									...
									(function (t) {
										return function (e) {
											switch (e.keyCode) {
												...
												case o.ENTER:
													return (
														D(t)(), e.preventDefault(), e.stopPropagation()
													);
												case o.ESCAPE:
